...
Forms with uncontrolled inputs return submitted values on errors and feed them back through `defaultValue`/`defaultChecked`; successful submissions omit them so React clears the form.
