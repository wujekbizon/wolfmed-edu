...
| `useSceneReveal(count)` | Staggered reveal-on-scroll animation sequencing. |
| `useHorizontalPath(count)` | Layout positions along a horizontal path (education-path visualization). |
