...
**Not fully audited function-by-function** — this catalog names and groups every export so the file is searchable and Golden-Rule-#3-checkable, matching the depth of [`25-helpers.md`](./25-helpers.md).
