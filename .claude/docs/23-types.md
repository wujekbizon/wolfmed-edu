...
| `memoryTypes.ts` | `TutorIntent`, `TutorIntentClassification`, `TutorIntentResult`, `TutorRoute`, `SelfStateContextResult` — closed contracts between semantic routing, typed memory recall, and tutor orchestration. |
