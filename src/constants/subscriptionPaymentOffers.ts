...
export const SUBSCRIPTION_PAYMENT_OFFERS = {
  ...
  angielski_medyczny_basic_monthly: {
    key: 'angielski_medyczny_basic_monthly',
    ...
    purchaseModel: 'subscription',
    entitlementSourceType: 'subscription',
    priceEnvName: 'STRIPE_ANGIELSKI_MEDYCZNY_BASIC_MONTHLY_PRICE_ID',
  },
  angielski_medyczny_premium_monthly: {
    key: 'angielski_medyczny_premium_monthly',
    courseSlug: 'angielski-medyczny',
    accessTier: 'premium',
    amount: 1999,
    currency: 'pln',
    ...
    purchaseModel: 'subscription',
    entitlementSourceType: 'subscription',
    priceEnvName: 'STRIPE_ANGIELSKI_MEDYCZNY_PREMIUM_MONTHLY_PRICE_ID',
  },
  jezyk_migowy_basic_monthly: {
    key: 'jezyk_migowy_basic_monthly',
    ...
    purchaseModel: 'subscription',
    entitlementSourceType: 'subscription',
    priceEnvName: 'STRIPE_JEZYK_MIGOWY_BASIC_MONTHLY_PRICE_ID',
  },
