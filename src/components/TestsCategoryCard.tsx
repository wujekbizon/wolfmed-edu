...
export default async function TestsCategoryCard({ item }: { item: PopulatedCategories }) {
  ...
  return (
    <div id={`kat-${item.value}`} className={`scroll-mt-24 relative flex flex-col lg:flex-row w-full rounded-2xl bg-slate-900 border border-white/[0.06] transition-all duration-300 overflow-hidden ${
