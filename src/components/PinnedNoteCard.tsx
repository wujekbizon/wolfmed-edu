...
export default function PinnedNoteCard({
  ...
  return (
    <article className='group relative bg-white ring-1 ring-zinc-200 hover:ring-slate-900/10 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 min-h-[140px]'>
      {note.category && (
        <div className='mb-3'>
