import { SelectedOptions1, SelectedOptions2, SelectedOptions3, SelectedOptions4, SelectedOptions5 } from '@/types/enums'
...
const CustomRadioInput: React.FC<CustomRadioInputInterface> = ({ option, onChange, inputValues }) => {
  return (
    <label className="flex flex-col items-center text-center text-zinc-800">
      <input
        type="radio"
        name={option.name}
        value={option.value}
