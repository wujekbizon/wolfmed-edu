...
export default function HeroTitle() {
  return (
    <>
      <div className="animate-fadeInUp mb-4 hidden sm:flex justify-center">
      ...
      <h1 className="text-4xl sm:text-6xl lg:text-6xl xl:text-7xl font-bold leading-tight tracking-tight mb-6 text-zinc-800">
      ...
      <p className="text-lg sm:text-xl lg:text-2xl text-zinc-700 mb-8 max-w-xl lg:max-w-2xl mx-auto animate-fadeInUp [--slidein-delay:1200ms] [animation-duration:0.9s]">
