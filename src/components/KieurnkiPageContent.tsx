        ...
        <div className='relative w-full flex flex-col items-center justify-center px-4 pb-12 md:pb-14 lg:pb-16'>
          <div className='max-w-2xl text-center'>
            ...
            <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-3 text-zinc-800 leading-tight'>
              Wybierz swój <span className='text-[#ff5b5b]'>kierunek</span>
            </h1>
            <p className='text-base md:text-lg text-zinc-600 leading-relaxed max-w-xl mx-auto'>
              Znajdź program edukacyjny idealnie dopasowany do Twoich potrzeb i
            ...
            <div className='flex flex-col sm:flex-row items-start justify-start gap-4 sm:gap-10'>
              <div className='flex items-center gap-3'>
                <div className='flex -space-x-2'>
                  ...
                  <div className='h-7 w-7 rounded-full border-2 border-white bg-rose-300' />
                </div>
              ...
              <div className='flex items-center gap-3'>
                ...
                <p className='text-sm text-zinc-500'>
                  <span className='font-semibold text-zinc-700'>5000+</span>{' '}
                  pytań testowych
                </p>
              </div>
              <div className='flex items-center gap-3'>
                ...
                <p className='text-sm text-zinc-500'>
                  <span className='font-semibold text-zinc-700'>6 500+</span>{' '}
                  studentów
                </p>
              </div>
            </div>
