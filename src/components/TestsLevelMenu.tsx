...
export default function TestsLevelMenu() {
  return (
    <div className="flex w-full flex-col items-center gap-4 rounded-2xl border border-red-200/60 bg-[#ffb1b1] shadow-md shadow-zinc-500 p-5 sm:p-8 lg:w-3/4 xl:w-2/3">
