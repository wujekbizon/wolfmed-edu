...
export default function CreateTab({ categories, isAdmin }: CreateTabProps) {
  return (
    <div className="w-full bg-white/60 backdrop-blur-sm rounded-xl border border-zinc-200/60 shadow-md p-4 sm:p-6 space-y-8 hover:shadow-lg transition-all duration-300">
      <ChooseAnswerCount />
