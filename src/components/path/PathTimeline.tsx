...
export default function PathTimeline({ path }: { path: CareerPath }) {
  ...
  return (
    ...
    >
      <div className="lg:sticky lg:top-24 flex flex-col overflow-hidden rounded-3xl bg-white ring-1 ring-zinc-900/5 lg:h-[90vh]">
        <header className="flex-none px-6 pt-10 sm:px-10 lg:px-14 lg:pt-11">
          ...
          <div className="mt-3.5 flex items-end justify-between gap-10">
            <h2
              id="path-title"
              className="max-w-[620px] text-3xl lg:text-[46px] font-bold leading-[1.05] tracking-[-0.03em] text-slate-900"
            >
              {path.headline}
            </h2>
        ...
        <div ref={viewport} className="flex-1 pt-6 lg:overflow-hidden">
          <div
            ref={track}
            className="flex flex-col gap-6 px-6 sm:px-10 lg:w-max lg:flex-row lg:px-14 lg:will-change-transform"
          >
        ...
        <footer className="flex-none flex flex-col items-start gap-4 px-6 pb-10 pt-8 sm:px-10 lg:flex-row lg:items-center lg:px-14 lg:pb-10">
          <a
            href={`#${PRICING_ANCHOR}`}
