...
export function NoteMetaFields({ formState }: { formState: FormState }) {
  return (
    <div className="flex flex-col gap-4 pt-2">
      <div className="relative w-full">
        <Input
          id="title"
          name="title"
          defaultValue={formState.values?.title?.toString() || ""}
      ...
      <div className="relative w-full">
        <Input
          id="category"
          name="category"
          defaultValue={formState.values?.category?.toString() || ""}
