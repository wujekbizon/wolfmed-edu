...
export default function Logo() {
  return (
    <Link href="/" className="z-10">
      <div className="hidden lg:flex gap-3 cursor-pointer items-center">
        <div className="h-12 w-12 shrink-0">
          <div className="w-12 h-12 bg-zinc-200 rounded-full border justify-center items-center border-zinc-400">
          <Image
