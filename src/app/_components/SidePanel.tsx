...
export default function SidePanel() {
  ...
  return (
    <motion.nav
      ...
      initial="close"
      className="z-10 hidden h-full min-w-20  flex-col gap-20 border rounded-2xl text-zinc-900 p-5 lg:flex border-red-200/60 bg-[#ffb1b1] shadow-md shadow-zinc-500"
    >
      <div className="flex w-full flex-row place-items-center justify-between gap-0.5">
        ...
        <button
          className="flex justify-center items-center pr-0.5 transition-all hover:scale-95 rounded-md border border-red-200/60 hover:border-amber-400/10 hover:shadow-sm hover:bg-[#ffa5a5] shadow-md shadow-zinc-500"
