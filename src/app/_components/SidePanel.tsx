...
export default function SidePanel() {
  ...
  return (
    <motion.nav
      ...
      initial="close"
      className="z-10 hidden h-full min-w-20  flex-col gap-20 border rounded-xl text-zinc-900 p-5 lg:flex border-red-200/60 bg-[#ffb1b1] shadow-md shadow-zinc-500"
    >
