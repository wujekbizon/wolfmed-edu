...
export default function Hero() {
  return (
    <section className="w-full gap-8 lg:w-3/4 flex flex-col items-center justify-around py-8 sm:py-16 px-4 sm:px-6">
      ...
      <div className="relative w-full h-full md:h-[490px] xl:w-3/4 border rounded-3xl animate-slideInDown opacity-0 [--slidein-delay:500ms] border-red-200/40 shadow-lg shadow-zinc-500">
        <Image
          src="/hero.jpg"
          alt="person"
          width={800}
