...
export default function Hero() {
  return (
    <section className="w-full gap-8 lg:w-3/4 flex flex-col items-center justify-around py-8 sm:py-12 px-4 sm:px-6">
      <div className="w-full flex items-center justify-center animate-slideInDown opacity-0 [--slidein-delay:300ms] bg-white rounded-3xl shadow shadow-zinc-500 border border-red-200/40 p-2">
        <h1 className="text-center py-8 sm:py-12 font-semibold w-full lg:w-[80%] text-[35px] sm:text-[40px] leading-[35px] md:text-[50px] sm:leading-[55px] text-zinc-950">
          {' '}
