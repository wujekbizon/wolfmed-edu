...
export default function About() {
  return (
    <section className="w-full py-8 md:py-12 px-4 md:px-12 xl:px-24">
      <div className="bg-zinc-900/90 rounded-2xl border-2 border-zinc-200 shadow shadow-zinc-500 flex flex-col items-center justify-center py-16 md:py-24 text-white relative overflow-hidden">
      <motion.div
        // @ts-ignore
