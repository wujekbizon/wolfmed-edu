...
export const Success = () => {
  ...
  return (
    <section className="relative min-h-[calc(100vh-70px)] bg-transparent p-6 flex flex-col justify-center items-center sm:p-12">
      <GradientOverlay />
      <FloatingShapes count={10} />
      <Confetti width={width} height={height}  />
      <div className="w-full max-w-2xl bg-zinc-50 z-20 rounded-3xl shadow-lg border border-zinc-200 overflow-hidden transition-all duration-300 hover:shadow-xl">
