...
export default function BlogPostCard({ post }: BlogPostCardProps) {
  return (
    <article className="group bg-[#2A2A3F]/40 rounded-2xl shadow-lg border border-[#3A3A5A]/30 hover:border-[#BB86FC]/10 transition-all duration-300 overflow-hidden hover:shadow-lg hover:shadow-[#BB86FC]/5 min-h-[340px]">
      <Link href={`/blog/${post.slug}`} className="flex flex-col md:flex-row gap-0 md:gap-6 h-full">
        <div className="relative w-full md:w-80 h-64 md:h-auto shrink-0 bg-linear-to-br from-[#3A3A5E]/30 to-[#30304B]/30">
          <Image
