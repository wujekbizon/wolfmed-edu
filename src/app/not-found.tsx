...
export default function NotFound() {
  return (
    <div className="flex h-[calc(100vh_-_186px)] rounded-3xl md:rounded-full mt-5 w-full flex-col items-center md:items-end justify-end bg-[url('/not-found.jpg')] bg-center bg-size-contain text-zinc-950">
      <Link
        href="/"
